...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            andrey.setFirstName("andrey");
            andrey.setLastName("fox");
            andrey.setBirthDate(dateFormat.parse("21.09.1986"));
            andrey.setCountry(User.Country.UKRAINE);
            andrey.setMale(true);

            javaRush.users.add(andrey);
