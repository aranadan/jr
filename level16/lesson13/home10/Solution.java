...
public class Solution {
    ...
    public static void systemOutPrintln(String fileName) throws FileNotFoundException, InterruptedException
    {
    ...
    static class ReadFileThread  extends Thread implements ReadFileInterface
    {
        ...
        public void run()
        {
            try
            {
                Scanner scan2 = new Scanner(new FileReader(fullFileName));
                while  (scan2.hasNext()){
